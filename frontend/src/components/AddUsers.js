...
const Addusers = () => {
  return (
   ...
   <div class="p-9 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 flex items-center justify-center">
      <div class="grid grid-cols-3 gap-4 mb-4 flex items-center justify-center"  >
         <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
		 <div class="mb-3">
  <label
    for="formFileMultiple"
    class="mb-2 inline-block text-neutral-700 dark:text-neutral-200"></label>
  <input
