    ...
    <>
            ...
            <li className="relative group">
              ...
              {showLaboratoriesSubMenu && (
                <ul className="mt-2 ml-8 space-y-2">
                  {/* Dummy submenu items */}
                  <li>
				  <div className="px-3" onClick={handleCivilEngineeringClick}> Human and Science
              ...
              ></i>
                    ...
                    {showCivilEngineeringSubMenu && (
                      <ul>
                        ...
                        <li>
                          <div className="px-5 "
                            onClick={() =>
                              handleSubMenuItemClick("Physics")
                            }
                          >
                  ...
                  <li>
                    <div className="px-3" onClick={handleArchitectureClick}> IT Department
      ...
      <div className="p-2 sm:ml-64 ">
        <div className="flex items-center justify-center p-2 border-2 border-gray-200 border-dashed rounded-lg">
		  ...
		  {activeMenuItem === "Chemistry" && <Lab />}
		  {activeMenuItem === "Physics" && <Lab />}
		  {activeMenuItem === "Nlp" && <Lab />}
